    ...
    public class ApplicantProfileLogic: BaseLogic<ApplicantProfilePoco>
    {
        ...
        protected override void Verify(ApplicantProfilePoco[] pocos)
        {
            ...
            foreach(ApplicantProfilePoco poco in pocos)
            {
                ...
                {
                    exceptions.Add(new ValidationException(111, "Current salary can not be negative : ApplicantProfilePoco"));
                }

                if(poco.CurrentRate < 0)
                {
                    exceptions.Add(new ValidationException(112, "Current rate can not be negative : ApplicantProfilePoco"));
                }
